...
public class PopulateDBQuestions {
    ...
    public void createQuestions () {
        if (questionsRepository.findByQuestionCodeIsIn("GBP")) {
            ...
            createQuestion("AUS", "In rhyming slang, if someone said they we going to have a “bo-peep”, what they be doing?", 7, "Having a sleep");
            createQuestion("AUS", "", 8, "");
            createQuestion("AUS", "", 9, "");
            createQuestion("AUS", "", 10, "");
            createQuestion("AUS", "", 11, "");
            createQuestion("AUS", "", 12, "");
            createQuestion("AUS", "", 13, "");
            createQuestion("AUS", "", 14, "");
            createQuestion("AUS", "", 15, "");
            createQuestion("AUS", "", 16, "");
            createQuestion("AUS", "", 17, "");
